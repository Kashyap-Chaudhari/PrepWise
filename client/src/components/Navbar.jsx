...
const Navbar = () => {
  ...
  // Handle clicking outside navbar to close mobile menu & user dropdown
  useEffect(() => {
    ...
    <>
      ...
      {isOpen && (
        <div
          ...
          className="fixed inset-0 bg-dark-950/60 backdrop-blur-sm z-40 md:hidden animate-fade-in"
        />
      )}
